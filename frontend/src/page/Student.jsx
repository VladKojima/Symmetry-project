...
function Student() {
    const handleDownloadPdf = () => {
        const element = document.getElementById('student-profile'); // Идентификатор вашего контейнера
        html2pdf().from(element).save(); // Преобразует HTML-элемент в PDF и сохраняет его
    };
        ...
        <div className="container-fluid">
            <div className="row g-4">
                ...
                <div className="container px-4 py-5">
                    ...
                    <div className="container px-4 py-5" id="student-profile">
                    <div className="row">
                            <div className="col-lg-3">
                                <div className="profile-photo-box-1">
                                    <img src={photo} alt="" className="profile-photo-1 img-fluid"/>
                                </div>
                                <div className="mt-4">
                                    <h5 className="mb-3">Теги: </h5>
                                    <div className="d-flex gap-3 flex-wrap">
